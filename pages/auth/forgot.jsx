                ...
                <div className="flex-[0.5] md:flex-[0.5] pt-10 ">
                    ...
                    <div>
                        <Link href="/auth/forgot">
                            <p className="pt-1 mb-3 text-[14px] text-sun font-medium" onClick={()=>changeNav('forgot')}>Forgot password?</p>
                        </Link>
                        <button className="bg-sun rounded-md px-11 mt-3 py-3 text-[12px] text-gray-900 font-bold">Login</button>
                        <p className="pt-4 mb-3 text-[14px] text-[#53504d] font-medium ">If you do not have an existing account<span className="text-sun"><a href="#"> Sign Up</a></span></p>
                    </div>
                    </form>
                </div>
            </div>
